      ...
      <div className="space-y-6">
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
          ...
          <ol className="text-indigo-700 space-y-3 list-decimal list-inside">
            <li><strong>Email Scanning:</strong> The system periodically checks your configured email account for new messages with attachments</li>
            ...
            <li><strong>Processing:</strong> Matched emails are processed according to their assigned rules and workflows</li>
            <li><strong>Post-Processing:</strong> Processed emails are archived or moved to prevent reprocessing</li>
          </ol>
        </div>
