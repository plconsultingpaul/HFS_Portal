            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateConfig(index, 'processingMode', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
                  <option value="extraction">Extract Mode</option>
                  <option value="transformation">Transform Mode</option>
                  <option value="imaging">Imaging Mode</option>
                </select>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              ...
              {config.processingMode === 'imaging' && (
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateConfig(index, 'imagingBucketId', e.target.value || undefined)}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >
                    <option value="">Select imaging bucket...</option>
                    {imagingBuckets.filter(b => b.isActive).map(b => (
