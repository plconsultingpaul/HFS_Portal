                  ...
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-0.5">
                      <button
                        type="button"
                        onClick={() => {
                          handleUpdateConfig(index, 'workflowVersion', 'v1');
                          handleUpdateConfig(index, 'workflowV2Id', undefined);
                        }}
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          handleUpdateConfig(index, 'workflowVersion', 'v2');
                          handleUpdateConfig(index, 'workflowId', undefined);
                        }}
                        className={`px-2.5 py-0.5 text-xs font-medium rounded-md transition-colors ${
